...
module.exports = {
  createUser: async (_, { body }, { dataSources, currentUser }, ____) => {
    const index = "users"
    let response = {}
    try {
      const id = nanoid()
  ...
  createProject: async (_, { body }, { dataSources, currentUser }, ____) => {
    const index = "projects"
    let response = {}
    try {
      body.owner = currentUser.ID
  ...
  createGadget: async (_, { body }, { dataSources, currentUser }, ____) => {
    const index = "gadgets"
    let response = {}
    try {
      body.owner = currentUser.ID
